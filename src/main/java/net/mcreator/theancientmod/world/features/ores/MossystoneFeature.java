...
public class MossystoneFeature extends OreFeature {
	public static MossystoneFeature FEATURE = null;
	...
	private static class MossystoneFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<MossystoneFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<MossystoneFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("the_ancient_mod:mossystone_match"), CUSTOM_MATCH);
		}
