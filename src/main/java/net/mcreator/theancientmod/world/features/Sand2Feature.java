...
public class Sand2Feature extends Feature<NoneFeatureConfiguration> {
	public static Sand2Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Sand2Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("the_ancient_mod:sand_2", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("the_ancient_mod:sand_2", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
