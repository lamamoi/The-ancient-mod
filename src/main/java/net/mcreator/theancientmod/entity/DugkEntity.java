...
package net.mcreator.theancientmod.entity;
...
public class DugkEntity extends PathfinderMob {
	...
	public DugkEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheAncientModModEntities.DUGK.get(), world);
	}

	public DugkEntity(EntityType<DugkEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.parrot.eat"));
	}
	...
	public static void init() {
		SpawnPlacements.register(TheAncientModModEntities.DUGK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
