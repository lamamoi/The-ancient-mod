...
public class RedskeletonEntity extends Monster {
	...
	public RedskeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheAncientModModEntities.REDSKELETON.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(TheAncientModModEntities.REDSKELETON.get(), SpawnPlacements.Type.ON_GROUND,
				Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL
						&& Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(TheAncientModModEntities.REDSKELETON.get(), 180);
	}
