...
import net.mcreator.theancientmod.item.CopperSwordItem;
import net.mcreator.theancientmod.item.CopperShovelItem;
import net.mcreator.theancientmod.item.CopperPickaxeItem;
import net.mcreator.theancientmod.item.CopperHoeItem;
import net.mcreator.theancientmod.item.CopperAxeItem;
...
public class TheAncientModModItems {
	...
	public static final RegistryObject<Item> DUGK_SPAWN_EGG = REGISTRY.register("dugk_spawn_egg", () -> new ForgeSpawnEggItem(TheAncientModModEntities.DUGK, -16740394, -671929, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	...
	public static final RegistryObject<Item> FROZENCHISELEDBRICKS = block(TheAncientModModBlocks.FROZENCHISELEDBRICKS, CreativeModeTab.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Item> PLATINUMARMOR_ARMOR_HELMET = REGISTRY.register("platinumarmor_armor_helmet", () -> new PlatinumarmorArmorItem.Helmet());
	public static final RegistryObject<Item> PLATINUMARMOR_ARMOR_CHESTPLATE = REGISTRY.register("platinumarmor_armor_chestplate", () -> new PlatinumarmorArmorItem.Chestplate());
	public static final RegistryObject<Item> PLATINUMARMOR_ARMOR_LEGGINGS = REGISTRY.register("platinumarmor_armor_leggings", () -> new PlatinumarmorArmorItem.Leggings());
	public static final RegistryObject<Item> PLATINUMARMOR_ARMOR_BOOTS = REGISTRY.register("platinumarmor_armor_boots", () -> new PlatinumarmorArmorItem.Boots());
	public static final RegistryObject<Item> COPPERARMOR_ARMOR_HELMET = REGISTRY.register("copperarmor_armor_helmet", () -> new CopperarmorArmorItem.Helmet());
	public static final RegistryObject<Item> COPPERARMOR_ARMOR_CHESTPLATE = REGISTRY.register("copperarmor_armor_chestplate", () -> new CopperarmorArmorItem.Chestplate());
	public static final RegistryObject<Item> COPPERARMOR_ARMOR_LEGGINGS = REGISTRY.register("copperarmor_armor_leggings", () -> new CopperarmorArmorItem.Leggings());
	public static final RegistryObject<Item> COPPERARMOR_ARMOR_BOOTS = REGISTRY.register("copperarmor_armor_boots", () -> new CopperarmorArmorItem.Boots());
