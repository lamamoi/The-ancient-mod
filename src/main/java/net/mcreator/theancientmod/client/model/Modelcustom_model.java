...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Dugk = partdefinition.addOrReplaceChild("Dugk",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -5.0F, -2.0F, 6.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(10, 8)
		...
		PartDefinition legs = Dugk.addOrReplaceChild("legs",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 1)
