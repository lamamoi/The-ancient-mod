...
public abstract class CopperarmorArmorItem extends ArmorItem {
	public CopperarmorArmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public SoundEvent getEquipSound() {
				return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.copper.step"));
			}
